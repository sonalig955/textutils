...
export default function Footer(props) {
    // https://www.linkedin.com/in/sonalig2019/  /
    // https://github.com/sonalig955
    return (
        <div style={{padding: "12px 0px", backgroundColor : "rgb(232, 227, 227)", textAlign: 'center', position:'fixed', width: '100%',height : '85px', bottom : '0', left: '0', right: '0', zIndex : '999'}}>
            ...
            <div className="text-center">
                    <h5>
                        Made with ❤️ by <strong style={{textDecoration : "none", color: "rgb(255 128 52)"}}>Sonali Gupta</strong>
                    </h5>
            </div> 

            <div className="text-center pt-1">
                <a href="https://www.linkedin.com/in/sonalig2019/" target="_blank" rel="noreferrer">
                    <i className="bi bi-linkedin mx-2" style={{fontSize : "20px"}}></i>
                </a>
                

                <a href="https://github.com/sonalig955" target="_blank" rel="noreferrer">
                    <i className="bi bi-github mx-2" style={{fontSize : "21px"}}></i>
                </a>

                <a href="mailto:sonalig2019@gmail.com" target="_blank" rel="noreferrer">
